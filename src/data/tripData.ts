...
export const itinerary: DayItinerary[] = [
  {
    ...
    elevationGain: "+1550m",
    difficulty: "moderate",
    route: "NJP Station → Jorethang → Rinchenpong",
...

  {
    ...
    highlights: [
      ...
      "Shinshore Bridge - one of Asia's highest suspension bridges",
      "Changay Waterfalls - hidden gem",
...

  {
    ...
    elevationGain: "-475m",
    difficulty: "moderate",
    route: "Pelling → Ravangla → Temi → Samdruptse → Namchi",
    ...
    highlights: [
      ...
      "Namchi Main Market - vibrant local market in the evening",
    ],
    foodSpots: [
...

  {
    ...
    elevationGain: "-1555m",
    difficulty: "moderate",
    route: "Namchi → Tarey Bhir → NJP",
    accommodation: "Trip ends at NJP Station",
    accommodationAddress: "New Jalpaiguri Railway Station, West Bengal",
    highlights: [
      "Char Dham darshan - 87ft Lord Shiva statue + 12 Jyotirlingas",
      "Tharey Bhir viewpoint - panoramic views of the plains and mountains",
