  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        mountain: {
          DEFAULT: "hsl(var(--mountain-blue))",
          light: "hsl(var(--mountain-blue-light))",
        },
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--sunset-orange) / 0.3)" },
          "50%": { boxShadow: "0 0 40px hsl(var(--sunset-orange) / 0.6)" },
        },
        "bounce-scroll": {
